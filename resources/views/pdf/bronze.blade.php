...
<body class="bg-gray-100 p-4">
    <div class="max-w-6xl mx-auto space-y-8">
        <!-- Bronze Card -->
        <div class="fidelity-card bronze-gradient text-white rounded-xl shadow-2xl overflow-hidden transition-transform duration-300 hover:scale-105">
            <div class="card-header p-6 relative overflow-hidden">
                <div class="shine absolute inset-0"></div>
                <h2 class="text-3xl font-bold mb-1 relative z-10">Carte Bronze</h2>
                <p class="text-xl opacity-90 relative z-10">Nom du magasin</p>
            </div>
            <div class="card-body bg-white p-6">
                ...
                <div class="points-container bg-orange-100 rounded-lg p-4 text-center">
                    <p class="text-lg font-semibold text-gray-800">Points de fidélité</p>
                    <p id="bronzePointsDisplay" class="text-3xl font-bold text-orange-600">0</p>
                </div>
            </div>
            <div class="card-footer bg-orange-50 p-4 text-center">
                <p class="text-sm text-gray-700">Commencez à accumuler des avantages !</p>
                <button class="bronze-points-btn mt-2 bg-orange-600 text-white py-2 px-4 rounded-full text-sm hover:bg-orange-700 transition-colors duration-300">Ajouter des points</button>
            </div>
        </div>
    </div>
