...
<body class="bg-gray-100 p-4">
    <div class="max-w-6xl mx-auto space-y-8">
        <!-- Gold Card -->
        <div class="fidelity-card gold-gradient text-white rounded-xl shadow-2xl overflow-hidden transition-transform duration-300 hover:scale-105">
            <div class="card-header p-6 relative overflow-hidden">
                <div class="shine absolute inset-0"></div>
                <h2 class="text-3xl font-bold mb-1 relative z-10">Carte Gold</h2>
            ...
            <div class="card-body bg-white p-6">
                ...
                <div class="points-container bg-yellow-100 rounded-lg p-4 text-center">
                    <p class="text-lg font-semibold text-gray-800">Points de fidélité</p>
                    <p id="goldPointsDisplay" class="text-3xl font-bold text-yellow-600">Ilimité</p>
                </div>
            </div>
            <div class="card-footer bg-yellow-50 p-4 text-center">
                <p class="text-sm text-gray-700">Profitez d'avantages exclusifs Gold !</p>
                <button class="gold-points-btn mt-2 bg-yellow-600 text-white py-2 px-4 rounded-full text-sm hover:bg-yellow-700 transition-colors duration-300">Ajouter des points</button>
            </div>
        </div>
